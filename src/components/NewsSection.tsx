...
const newsItems: NewsItem[] = [
  {
    ...
    summary:
      "Updated safety procedures are now in effect for all depot operations. All staff must complete the new training module by end of week.",
    category: "urgent",
  ...
  },
  {
    ...
    summary:
      "Vehicle maintenance schedules have been updated. Check the maintenance portal for your assigned vehicles.",
  ...
  },
  {
    ...
    summary:
      "The depot management system upgrade was completed overnight with no reported issues.",
    category: "success",
  ...
  },
  {
    ...
    summary:
      "Severe weather conditions expected tomorrow. Review storm protocols and ensure all outdoor equipment is secured.",
    category: "urgent",
  ...
  },
  {
    ...
    summary:
      "Updated equipment training videos are now available in the training section. Completion required for certification renewal.",
    category: "info",
        ...
        <CardContent>
          <div className="space-y-4">
            {newsItems.map((item) => (
              <div
                key={item.id}
                className={`p-4 bg-depot-surface rounded-lg border-l-4 ${getPriorityColor(
                  item.priority
                )} transition-all hover:bg-depot-surface-elevated`}
              >
