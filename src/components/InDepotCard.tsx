        ...
        <div className="divide-y divide-gray-700">
          {staffInDepot.length === 0 ? (
            <div className="px-2 py-2 text-center">
              <p className="text-[10px] xl:text-[1.5vw] text-gray-400">
                ...
                >
                  ...
                  <div className="block sm:hidden space-y-0.5">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="sm:text-[22px] xl:text-[1.5vw] font-medium text-gray-200">
                        {staff.name}
                      </span>
                    </div>
                    <div className="sm:text-[22px] xl:text-[1.5vw] text-gray-400">
                      {staff.company}
                    </div>
                    <div
                      className={`sm:text-[22px] xl:text-[1.5vw] text-gray-300 inline-block ${
                        isSpecialRole ? "bg-green-600 px-2 py-0.5 rounded" : ""
                      }`}
                    >
                      {staff.reason}
                    </div>
